...
project = u'ygshen‘s blog' 
copyright = u'2020, 路索化工'
...
latex_documents = [
  ('index', 'python3-cookbook.tex', u'《帮助系统》',
   u'路索化工', 'howto'),
]
...
texinfo_documents = [
  ('index', 'Python-Time', u'《帮助系统》',
   u'路索化工', 'Python-Time', '《帮助系统》',
   'Miscellaneous'),
]
